...
ASTRO_EVENTS_FILE    = Path(__file__).parent / "astro_events_2026.json"
WEEKLY_THEMES_FILE   = Path(__file__).parent / "weekly_themes2.json"
...
def load_todays_voiceover_scenes(target_date: str) -> list:
    ...
    scenes = []
    for f in sorted(scripts_dir.glob(f"voiceover2_{target_date}_*.txt")):
        try:
...
- ZÁKAZ VYMYŠLENÝCH TRANZITŮ: NIKDY nevymýšlej konkrétní retrográd nebo tranzit ("Pluto retrográduje", "Uran vstupuje do rychlé fáze", "Merkur přechází do X"), pokud ho voiceover neobsahuje. Místo toho piš o trvalých vlastnostech vládnoucí planety daného znamení (např. "Pluto, tvůj vládce, tě dnes vede k transformaci").
...
- ZÁKAZ VYMYŠLENÝCH TRANZITŮ: NIKDY nevymýšlej konkrétní retrográd nebo tranzit ("Pluto retrográduje", "Uran vstupuje do rychlé fáze"), pokud ho voiceover nebo TikTok caption neobsahuje. Piš o trvalých vlastnostech vládnoucí planety.
...
Výstup JEN samotný text — žádné nadpisy, žádné labely, žádné hvězdičky."""
    ...
    komentar_trigger_pools = {
        'Beran':    [
            ...
            'Napiš, co se stalo naposledy, kdy jsi šel do toho bez váhání.',
        ...
        'Býk':      [
            ...
            'Napiš, co se stalo naposledy, kdy jsi to nepustil a měl pravdu.',
            'Proč to držíš? Napiš jedno slovo ⬇️',
            'Napiš ANO, pokud tahle trpělivost tě jednou zachránila.',
            'Co by se stalo, kdybys pustil jednu věc, na které nejvíc záleží?',
        ],
        'Blíženci': [
            ...
            'Napiš, co se stalo naposledy, kdy jsi řekl vše, co jsi cítil.',
            'Proč přepínáš? Napiš jedno slovo ⬇️',
            'Napiš ANO, pokud máš dnes v hlavě dvě protichůdné pravdy najednou.',
            'Která polovina tebe se dnes víc bojí být viděná?',
        ],
        'Rak':      [
            ...
            'Napiš, co se stalo naposledy, kdy jsi přestal chránit a začal pustit.',
            'Proč pečuješ? Napiš jedno slovo ⬇️',
            'Napiš ANO, pokud tohle cítíš, ale zatím jsi to nikomu neřekl.',
        ...
        'Lev':      [
            ...
            'Napiš, co se stalo naposledy, kdy jsi zářil a nikdo si toho nevšiml.',
            'Proč potřebuješ být viděn? Napiš jedno slovo ⬇️',
            'Napiš ANO, pokud se uvnitř skrýváš za tím, co ukazuješ navenek.',
            'Co by ses odvážil ukázat, kdyby tě nikdo nesoudil?',
        ],
        'Panna':    [
            ...
            'Napiš, co se stalo naposledy, kdy jsi přestal opravovat a nechal věci být.',
        ...
        'Váhy':     [
            ...
            'Napiš, co se stalo naposledy, kdy ses rozhodl rychle a nelitoval.',
            'Proč vždy vážíš? Napiš jedno slovo ⬇️',
            'Napiš ANO, pokud se dnes snažíš udělat šťastnými lidi místo sebe.',
            'Co by sis vybral, kdyby výběr neovlivnil nikoho okolo tebe?',
        ],
        'Štír':     [
            ...
            'Napiš, co se stalo naposledy, kdy jsi někomu plně důvěřoval.',
        ...
        'Střelec':  [
            ...
            'Napiš, co se stalo naposledy, kdy jsi odešel bez plánu a bylo to správně.',
            'Proč utíkáš? Napiš jedno slovo ⬇️',
            'Napiš ANO, pokud tě tato svoboda někdy stála víc, než ses chystal dát.',
        ...
        'Kozoroh':  [
            ...
            'Napiš, co se stalo naposledy, kdy ses dovolil zastavit a nebylo to slabostí.',
        ...
        'Vodnář':   [
            ...
            'Sedí to? ANO nebo NE ⬇️',
            'Napiš, co se stalo naposledy, kdy jsi sdílel svůj nápad a ostatní nechápali.',
            'Proč myslíš jinak? Napiš jedno slovo ⬇️',
            'Napiš ANO, pokud se cítíš cizincem ve světě, který ještě nedohonil tvoje myšlenky.',
        ...
        'Ryby':     [
            ...
            'Napiš, co se stalo naposledy, kdy jsi věřil svému pocitu a měl pravdu.',
...
def main():
    ...
    print(f"\n=== Voiceover Generator | datum: {target_date} | pocet: {count} ===\n")
