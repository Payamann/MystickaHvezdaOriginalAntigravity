(()=>{(function(){"use strict";const m=`
    ...
    `;function T(){}function p(t){const e=new URL(window.location.href);return e.searchParams.set("utm_source",t),e.searchParams.set("utm_medium","share"),e.searchParams.set("utm_campaign","result_share"),e.toString()}function a(t,e={}){window.MH_ANALYTICS?.trackEvent?.(t,{source:"result_share",page_path:window.location.pathname,...e})}const b=[".tarot-profile-cta",".tarot-yes-no-profile-cta",'[class*="profile-cta"]','[class*="signup-cta"]','[class*="register-cta"]',".mh-email-bridge"];function f(t){for(const e of b){const r=t.querySelector(e);if(r)return r}return null}function c(t,e){const r=f(t);return r&&r.parentElement?e.parentElement===r.parentElement&&e.nextElementSibling===r?!1:(r.parentElement.insertBefore(e,r),!0):t.lastElementChild!==e?(t.appendChild(e),!0):!1}function g(t,e,r){if(!t||t.querySelector(".share-result-btn"))return;const s=document.createElement("div");s.innerHTML=m;const l=t.querySelector("#detail-numbers");if(l){const n=l.closest("p")||l.parentElement;s.classList.add("share-result-wrapper","share-result-wrapper--horoscope"),n.insertAdjacentElement("afterend",s)}else s.classList.add("share-result-wrapper"),c(t,s);const w=s.querySelector(".share-result-btn"),_=s.querySelector(".share-toast");w.addEventListener("click",async()=>{const n=r||document.querySelector(".reading-text, .result-text, [data-share-text]")?.innerText?.slice(0,200)||"",d=e||document.title,h=/Android|iPhone|iPad/i.test(navigator.userAgent)?"mobile_share":"web_share",i=p(h),o={share_method:navigator.share?"native":"clipboard",utm_source:h,has_share_text:!!n};if(a("share_click",o),navigator.share)try{await navigator.share({title:d,text:n,url:i}),a("share_completed",{...o,share_method:"native"});return}catch{}try{await navigator.clipboard.writeText(`${d}
